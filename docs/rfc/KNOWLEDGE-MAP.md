...
| Nível de bateria do client | `docs/specs/Client-Battery-Level.md` (`EKOM-BATTERY-001`); ADR-0005 | v0.5 em rascunho [`Draft`]; análise **Pronta** [`Ready`]; ADR-0005 `Accepted` | Nenhum; não implementado | Reanálise da v0.5 contra `55bc730`: Pronta, sem bloqueadores | Elegível a ordem explícita de implementação |
...
│   │       └── Nível de bateria — v0.5 Ready, não implementado
