...
| Deep sleep do client | `docs/specs/Client-Deep-Sleep.md`; `docs/specs/ISSP-Configurable-Bootstrap.md`; `docs/specs/ISSP-Reusable-Components.md`; `docs/specs/Firmware-Variants-Menuconfig.md`; ADR-0002 | Rascunho; v0.6 analisada com prontidão condicionada | `SmartSysApp`; componentes ISSP; product firmware; board model | Análises das v0.3, v0.4, v0.5 e v0.6; testes e hardware não executados | Especificado |
