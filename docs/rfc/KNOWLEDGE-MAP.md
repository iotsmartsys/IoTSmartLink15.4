...
| Sensor de presença a bateria | `docs/specs/Presence-Sensor-Battery-H2.md` (`EKOM-PRESENCE-001`); ADR-0005 | v0.2 em Rascunho [`Draft`]; análise da versão corrente pendente | `client_154/main/`; `components/issp_app_154`; `components/issp_behaviors`; tradução de eventos do coordenador | Análise v0.1: `docs/reports/presence-sensor-battery-h2/analysis/2026-09-07T194045Z-v0.1-373a6d1b-implementability-analysis.md`; `Not Ready — Specification Defect` histórico; decisão para B1 incorporada à v0.2, ainda sem reanálise | Especificado; implementação não iniciada; testes fora do recorte |
