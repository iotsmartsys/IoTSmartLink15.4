...
| Sensor de luminosidade a bateria | `docs/specs/Light-Sensor-Battery-H2.md` (`EKOM-LIGHT-001`) | v0.2 Rascunho; cadência e precisão pendentes | Sem implementação | Análise do rascunho anterior Not Ready; v0.2 publica percentual direto ADC e elimina estados | Nova análise pendente; evento 6 alocado pela ADR-0005 |
