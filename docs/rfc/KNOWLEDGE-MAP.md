...
| Identidade de reports | `docs/specs/ISSP-Report-Identity.md`; ADR-0004 | v0.2 em autoria [`Draft`] | `components/issp_core`; `issp_transport_154`; `components/issp_app_154`; `coordinator_154/main/` | Diagnóstico de forwarding; análise v0.1 Not Ready; reanálise v0.2 pendente | Especificado; não implementado |
...
| Enlace ACK/retry | `docs/specs/ISSP-Report-Identity.md`; `EKM-GAP-0006` | Identidade v2 em autoria [`Draft`] | Transporte, executor e coordenador | Limitação observada em hardware | Especificado; não implementado |
