...
| Registry de devices pareados do coordenador | `docs/specs/ISSP-Coordinator-Paired-Device-Registry.md` | Proposed | In Progress; Not Ready; Implementable | `coordinator_154/main/device_registry.{h,c}` + `device_registry_nvs.c`, integrado em `main.c` | Correção v0.3 em 01/08/2026: fail-closed e remoção de erase global implementados; build ESP32-C6 aprovado e QEMU ESP32-C3 13/13 aprovado, incluindo G3-F. G1, G3-N e hardware continuam pendentes; sem aceite |
