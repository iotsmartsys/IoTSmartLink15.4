...
| Sensor de luminosidade a bateria | `docs/specs/Light-Sensor-Battery-H2.md` (`EKOM-LIGHT-001`) | v0.4 Draft; análise Ready; implementação aguarda ordem | Produto/board Light Sensor H2; CMake/Kconfig; capability existente de bateria | Análise v0.4: `docs/reports/light-sensor-battery-h2/analysis/2026-09-08T203902Z-v0.4-2cd00a8a-implementability-analysis.md` | v0.3 Done preservada; v0.4 acrescenta bateria opcional, sem implementação ou hardware nesta atuação |
...
│   │   │   ├── Light sensor battery H2 — percentual ADC por boot; bateria opcional especificada na v0.4, Ready
...
│   │   │   ├── Light Sensor H2 — LDR GPIO2/10 kohm; recurso de bateria especificado na v0.4, não implementado
...
flowchart LR
    ...
    LightBatterySpec["v0.4 · bateria opcional · Ready · implementação pendente"] -.->|"battery_measurement ADC1 canal 0"| LightBoard
