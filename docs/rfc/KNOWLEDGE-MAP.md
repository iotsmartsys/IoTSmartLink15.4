...
| Sensor de luminosidade a bateria | `docs/specs/Light-Sensor-Battery-H2.md` (`EKOM-LIGHT-001`) | v0.1 Rascunho; calibração pendente | Sem implementação | Análise do rascunho anterior Not Ready; revisão explicita precedência noturna | Nova análise pendente; evento 6 alocado pela ADR-0005 |
