...
| Registry de devices pareados do coordenador | `docs/specs/ISSP-Coordinator-Paired-Device-Registry.md` | Draft | In Progress; Not Ready; Pending Review | `coordinator_154/main/device_registry.{h,c}` + `device_registry_nvs.c`, integrado em `main.c` | Revisão encerrada sem aceite em 01/08/2026; achados de fail-closed, apagamento global da NVS e gates incompletos preservados. Arquiteto determina nova autoria com escopo completo; nova análise de implementabilidade será obrigatória |
