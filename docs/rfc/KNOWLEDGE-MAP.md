...
| Deep sleep do client | `docs/specs/Client-Deep-Sleep.md`; ADR-0002 | Rascunho e análise | `SmartSysApp`; product firmware; board model | Análise inicial; testes e hardware não executados | Especificado com pendências |
