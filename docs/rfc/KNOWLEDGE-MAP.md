...
|---|---|---|---|
| Instruções para agentes | `AGENTS.md` | Normativo | Active; EKOM 4.4 |
| Método e perfis | `/Users/marcelocostamiranda/source/EKM-guidelines` | Normativo externo | EKOM 4.4 vigente |
...
| Nível de bateria do client | `docs/specs/Client-Battery-Level.md` (`EKOM-BATTERY-001`); ADR-0005 | v0.5 em implementação [`In Progress`]; análise **Pronta** [`Ready`]; ADR-0005 `Accepted` | `components/issp_app_154`; `components/issp_behaviors`; `client_154/main/` | Análise e relatório de implementação v0.5; builds H2 das duas composições concluídos; testes e hardware não executados | Implementada em código; evidência de hardware reservada a etapa posterior |
...
│   │       └── Nível de bateria — v0.5 implementada em código; hardware pendente
