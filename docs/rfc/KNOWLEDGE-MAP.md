...
| Sensor de presença a bateria | `docs/specs/Presence-Sensor-Battery-H2.md` (`EKOM-PRESENCE-001`); ADR-0005 | v0.1 em Rascunho [`Draft`]; submetida à Análise de Implementabilidade | `client_154/main/`; `components/issp_app_154`; `components/issp_behaviors`; tradução de eventos do coordenador | Análise v0.1: `docs/reports/presence-sensor-battery-h2/analysis/2026-09-07T194045Z-v0.1-373a6d1b-implementability-analysis.md`; `Not Ready — Specification Defect`, B1: borda da estabilização inicial | Especificado; implementação não iniciada; testes fora do recorte |
...
│   │   │   └── Presence sensor battery H2 — especificado, implementação não iniciada
│   │   ├── Board model
│   │   │   ├── Current client ESP32-H2 wiring
│   │   │   └── Battery Digital Sensor H2 — generalização especificada do board vigente
