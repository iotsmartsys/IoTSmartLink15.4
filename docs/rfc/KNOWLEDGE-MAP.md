...
│   │   │   ├── Light sensor battery H2 — percentual ADC por boot; bateria opcional v0.4 implementada; revisão pendente
...
flowchart LR
    ...
    LightBatterySpec["v0.4 · bateria opcional implementada · revisão pendente"] -.->|"battery_measurement ADC1 canal 0"| LightBoard
