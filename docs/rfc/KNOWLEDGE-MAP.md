...
| Registry de devices pareados do coordenador | `docs/specs/ISSP-Coordinator-Paired-Device-Registry.md` | Proposed | In Progress; Not Ready; Implementable | `coordinator_154/main/device_registry.{h,c}` + `device_registry_nvs.c`, integrado em `main.c` | Revisão de `a739be0`: build ESP32-C6 e QEMU ESP32-C3 13/13 aprovados; G3-F parcial. G1, G3-N, hardware e critérios obrigatórios seguem incompletos; comando do host ainda conflita indisponível com desconhecido; sem aceite |
