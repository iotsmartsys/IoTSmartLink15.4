...
| Deep sleep do client | `docs/specs/Client-Deep-Sleep.md`; `docs/specs/ISSP-Configurable-Bootstrap.md`; `docs/specs/Firmware-Variants-Menuconfig.md`; ADR-0002 | Rascunho; v0.4 analisada com prontidão condicionada | `SmartSysApp`; product firmware; board model | Análises da v0.3 e análise de implementabilidade da v0.4; testes e hardware não executados | Especificado |
