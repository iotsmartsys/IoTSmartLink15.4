...
│   │   │   └── Presence sensor battery H2 — presence_sensor_battery_h2, implementado; hardware não executado
│   │   ├── Board model
