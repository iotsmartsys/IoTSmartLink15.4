...
| Registry de devices pareados do coordenador | `docs/specs/ISSP-Coordinator-Paired-Device-Registry.md` | Proposed | Not Started; Not Ready; Implementable | `coordinator_154` (implementação ainda inexistente) | Critérios COORD-REG-AC-001 a AC-008 propostos; revisão de implementabilidade concluída em 31/07/2026 (seção 16.1); nenhuma execução funcional nesta etapa |
