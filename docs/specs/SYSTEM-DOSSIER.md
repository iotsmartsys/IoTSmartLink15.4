...
| Remediação de débitos técnicos | `Technical-Debt-Remediation.md`; ADR-0005 | v0.2 em implementação [`In Progress`]; análise `Ready` | Identidade de capability, guarda de eventos, telemetria observável e baseline rastreada |
