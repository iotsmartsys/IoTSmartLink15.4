...
| Remediação de débitos técnicos | `Technical-Debt-Remediation.md`; ADR-0005 | v0.1 em Rascunho [`Draft`]; análise pendente | Identidade de capability, guarda de eventos, telemetria observável e baseline rastreada |
