...
| Remediação de débitos técnicos | `Technical-Debt-Remediation.md`; ADR-0005 | v0.2 em Rascunho [`Draft`]; emenda do tipo 4 aceita; nova análise pendente | Identidade de capability, guarda de eventos, telemetria observável e baseline rastreada |
